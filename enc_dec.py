...
from self_attention_layer import self_attention, feed_forward, cross_attention

def encoder(input_shape, key_dim, ff_dim, dropout = 0.1, prefix = "enc", **kwargs):
    """
        One encoder unit. The input and output are in the same shape so we can daisy 
        chain multiple encoder units into one larger encoder
    """
